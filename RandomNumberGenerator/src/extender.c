...
int main(int argc, char *argv[]) {
    ...
    if(argc != 5) {
        fprintf(stderr, "Error! %s requires exactly 4 arguments: a file to read in random numbers, the number of ints you have in the file, a file to write the extended bits to, and the number of random bytes you want written to your file\n", argv[0]);
        return EXIT_FAILURE;
    }
    char * infile = argv[1];
